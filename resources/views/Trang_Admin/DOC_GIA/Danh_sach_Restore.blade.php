                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{route('trang-doc-gia.danh-sach')}}" class="btn btn-success waves-effect waves-light" style="margin-bottom:10px" > Trang Chủ <i class="fas fa-list-ul"></i></a>
                                <table id="basic-datatable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <a href="{{ route('trang-doc-gia.khoi-phuc', ['id' => $DanhSach->id]) }}" class="btn btn-outline-success btn-rounded waves-effect waves-light">
