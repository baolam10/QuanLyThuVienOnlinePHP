...
@if (session('flash_message_insert'))
    ...
    <script type="text/javascript">
        swal("Thêm Sách Thành Công!","Chọn OK để tiếp tục!","success");
    </script>
@endif
@if (session('flash_message_update'))
    ...
    <script type="text/javascript">
        swal("Cập Nhật Sách Thành Công!","Chọn OK để tiếp tục!","success");
    </script>
@endif  
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{route('trang-sach.danh-sach-restore')}}" class="btn btn-danger waves-effect waves-light" style="margin-bottom:10px" >Khôi Phục <i class="fas fa-recycle"></i></a> 
                                <a href="{{ route('trang-sach.them-moi')}}" class="btn btn-success waves-effect waves-light" style="margin-bottom:10px" > Thêm Mới <i class="fas fa-plus-circle"></i></a>  
                                <table id="basic-datatable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <a href="{{ route('trang-sach.cap-nhat', ['id' => $DanhSach->id]) }}" class="btn btn-outline-success btn-rounded waves-effect waves-light">
                                                    <i class="mdi mdi-grease-pencil"></i>
                                                </a>
                                            </th>    
                                            <th>
                                                <a href="{{ route('trang-sach.xoa', ['id' => $DanhSach->id]) }}" class="btn btn-danger btn-rounded waves-effect waves-light">
